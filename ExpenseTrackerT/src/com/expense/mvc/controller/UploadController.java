...
public class UploadController {
	private static final Logger logger = Logger.getLogger("log." + UploadController.class);
	...
	@ResponseBody
	public String process1(Model model, HttpServletRequest request, HttpSession session) throws FileUploadException,
